...
[Pull requests are welcome](https://github.com/cjey/go-libvirt/blob/master/CONTRIBUTING.md)!
...
`godoc github.com/cjey/go-libvirt DomainShutdownFlags`
...
```
$ godoc github.com/cjey/go-libvirt DomainShutdownFlagValues
